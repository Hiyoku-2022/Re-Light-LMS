...
export function Header({ dashboardType, onToggleSidebar }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white shadow flex items-center justify-between px-4 py-3 z-10">
      ...
      {isSidebarOpen && (
        <aside className="sidebar fixed top-0 right-0 h-full bg-soft-sky w-32 shadow-lg flex flex-col justify-between">
